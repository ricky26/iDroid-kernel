...
typedef error_t (*vfl_open_t)(struct _vfl_device *);
typedef void (*vfl_close_t)(struct _vfl_device *);

typedef struct apple_nand *(*vfl_get_device_t)(struct _vfl_device *);
 ...
 * @ingroup VFL
 */
struct apple_nand *vfl_get_device(vfl_device_t *_vfl);
